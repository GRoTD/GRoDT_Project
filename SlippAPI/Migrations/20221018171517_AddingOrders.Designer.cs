...
namespace SlippAPI.Migrations
{
    ...
    [Migration("20221018171517_AddingOrders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Slipp.Services.Models.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Slipp.Services.Models.Sale", b =>
                {
                    ...
                    b.HasOne("Slipp.Services.Models.Order", "Order")
                        .WithOne("Sale")
                        .HasForeignKey("Slipp.Services.Models.Sale", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
